...
LINHAS = [
    ...
    ("borboleta alavanca", "VALVULA_BORBOLETA", {"acionamento": "ALAVANCA"}),
    ("borboleta caixa red.", "VALVULA_BORBOLETA", {"acionamento": "CAIXA"}),
    ("borboleta volante", "VALVULA_BORBOLETA", {"acionamento": "VOLANTE"}),
